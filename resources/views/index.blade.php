                                            ...
                                            <form class="form-horizontal" method="POST" action="{{route('medical.center.regester.submit')}}" name="regForm" >
                                                ...
                                                <div class="form-group" ng-class="{true: 'error'}[submitted && regForm.email.$invalid]">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <span class="help-inline" ng-show="submitted && regForm.last_name.$error.required">Email Required</span>
                                                ...
                                                <div class="form-group" ng-class="{true: 'error'}[submitted && regForm.conform-password.$invalid]">
                                                    <label for="inputPassword3" class="col-sm-4 control-label">Confirm Password</label>
                                                    <div class="col-sm-8">
                                                        <input class="form-control" id="inputPassword3" placeholder="Confirm Password" type="password" name="conform-password" required="required">
                                                        <span class="help-inline" ng-show="submitted && regForm.conform-password.$error.required">Conform Password Required</span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
